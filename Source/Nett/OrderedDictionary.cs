// Taken from https://github.com/jehugaleahsa/truncon.collections.OrderedDictionary

// disable coding convention checks as code was taken from another project
...
namespace Nett.Collections
{
    ...
    [DebuggerTypeProxy(typeof(OrderedDictionary<,>.OrderedDictionaryDebugView<,>))]
    public sealed class OrderedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IList<KeyValuePair<TKey, TValue>>
    {
        internal Dictionary<TKey, TValue> Dictionary => this.dictionary;
